...
//		driver = new FirefoxDriver();
	...
	public void he_enters_following_data(DataTable table){
		//Initialize data table 
	      ...
	      driver.findElement(By.id("u_0_v")).sendKeys(data.get(1).get(2));
	      driver.findElement(By.id("u_0_v")).sendKeys(data.get(2).get(2));
	      driver.findElement(By.id("u_0_v")).sendKeys(data.get(3).get(2));
